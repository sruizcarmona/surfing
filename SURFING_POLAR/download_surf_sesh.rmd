---
title: "Download latest SURFING sessions "
output:
 html_notebook
---
...
```{r}
my_config <- read_yaml("config.yml_SURF")
```
...
# ###### get user info
# ######
# my_form = GET(paste0("https://www.polaraccesslink.com/v3/users/", my_config$user_id),
#                  add_headers(Accept = "application/json"),
#                  add_headers(Authorization = paste0("Bearer ", my_config$access_token)))
# warn_for_status(my_form)
# my_data = jsonlite::fromJSON(content(my_form, as="text"))
# my_data
```
...
```{r}
# download tcx data, fix, and save
